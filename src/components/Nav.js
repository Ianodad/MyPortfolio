...
class Nav extends React.Component  {
  ...
  render() {
    const { index_classname, portfolio_classname, about_classname, blog_classname } = this.state; 
    return(
      <div className="navbar-container">
        ...
        <div className="navbar-pages-container">
            ...
            <div className="navbar-pages">
                <FontAwesomeIcon icon={ faFile } className={blog_classname} style={{ fontSize:'30px', float:'left'}}/>
                &nbsp;&nbsp;&nbsp;
                <Link to="/blog"><p>blog.html</p></Link>
            </div>
            {/* <div className="navbar-pages">
